...
@section('styles')
    ...
    <link href="{{URL::to('admin/coco/assets/libs/jquery-jvectormap/css/jquery-jvectormap-1.2.2.css')}}"
          rel="stylesheet" type="text/css"/>
    <link href="{{URL::to('admin/coco/assets/libs/jquery-clock/clock.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{URL::to('admin/coco/assets/libs/bootstrap-calendar/css/bic_calendar.css')}}" rel="stylesheet"
          type="text/css"/>
    <link href="{{URL::to('admin/coco/assets/libs/sortable/sortable-theme-bootstrap.css')}}" rel="stylesheet"
          type="text/css"/>
    <link href="{{URL::to('admin/coco/assets/libs/jquery-weather/simpleweather.css')}}" rel="stylesheet"
          type="text/css"/>
    <link href="{{URL::to('admin/coco/assets/libs/bootstrap-xeditable/css/bootstrap-editable.css')}}" rel="stylesheet"
          type="text/css"/>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 portlets">
                    <div id="weather-widget" class="widget">
                        ...
                        <button class="js-geolocation btn btn-sm btn-default" style="display: none;">Use Your Location
                        </button>
                    </div>
                </div>
...
@section('scripts')
    <script src="{{URL::to('admin/coco/assets/libs/d3/d3.v3.js')}}"></script>
    <script src="{{URL::to('admin/coco/assets/libs/rickshaw/rickshaw.min.js')}}"></script>
    <script src="{{URL::to('admin/coco/assets/libs/raphael/raphael-min.js')}}"></script>
    <script src="{{URL::to('admin/coco/assets/libs/morrischart/morris.min.js')}}"></script>
    <script src="{{URL::to('admin/coco/assets/libs/jquery-knob/jquery.knob.js')}}"></script>
    <script src="{{URL::to('admin/coco/assets/libs/jquery-jvectormap/js/jquery-jvectormap-1.2.2.min.js')}}"></script>
    <script src="{{URL::to('admin/coco/assets/libs/jquery-jvectormap/js/jquery-jvectormap-us-aea-en.js')}}"></script>
    <script src="{{URL::to('admin/coco/assets/libs/jquery-clock/clock.js')}}"></script>
    <script src="{{URL::to('admin/coco/assets/libs/jquery-easypiechart/jquery.easypiechart.min.js')}}"></script>
    <script src="{{URL::to('admin/coco/assets/libs/jquery-weather/jquery.simpleWeather-2.6.min.js')}}"></script>
    <script src="{{URL::to('admin/coco/assets/libs/bootstrap-xeditable/js/bootstrap-editable.min.js')}}"></script>
    <script src="{{URL::to('admin/coco/assets/libs/bootstrap-calendar/js/bic_calendar.min.js')}}"></script>
    <script src="{{URL::to('admin/coco/assets/js/apps/calculator.js')}}"></script>
    <script src="{{URL::to('admin/coco/assets/js/apps/todo.js')}}"></script>
    <script src="{{URL::to('admin/coco/assets/js/apps/notes.js')}}"></script>
    <script src="{{URL::to('admin/coco/assets/js/pages/index.js')}}"></script>
@endsection